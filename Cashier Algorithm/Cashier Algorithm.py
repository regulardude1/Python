#This is a algorthim that calculates the total price of items, the amount paid by the customer, and the change to be given to the customer.
#The program will ask the user for the number of items they have, generate random prices for each item, calculate the total price of the items, and add a random amount to 
#the total price as the amount paid by the customer.

# This is a program to look through numbers within an array using binary search algorithm
# The program will ask the user for a number to search for and return the index of the number if found
# If the number is not found, the program will return "Target not found"
